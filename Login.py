...
# # Carregar animação
# with open("C:/Users/TiagoVettorazzi/OneDrive - Grupo Portfolio/Área de Trabalho/Streamlit/Animation - 1732641095685.json", "r") as f:
...
#         p {
#             font-size: 18px;
#             color: #7F2097; /* Cinza para o subtítulo */
#         }
#         .login-button {
